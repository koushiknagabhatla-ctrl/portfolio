      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-left">
            ...
            <address className="contact-details" ref={contactsRef}>
              <a href="mailto:koushiknagabhatla@gmail.com" className="contact-item" aria-label="Email Koushik at koushiknagabhatla@gmail.com">
              ...
              <a href="tel:+917989237906" className="contact-item" aria-label="Call Koushik at +91 7989237906">
          ...
          <div className="footer-right" ref={socialsRef}>
            ...
            <nav className="socials-list" aria-label="Social media links">
              <a href="https://github.com/koushiknagabhatla-ctrl" target="_blank" rel="noopener noreferrer" aria-label="GitHub profile">
              ...
              <a href="https://www.linkedin.com/in/koushik-nagabhatla-113a493a2" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn profile">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg> LinkedIn
              </a>
              <a href="https://www.instagram.com/__.koushik__.7" target="_blank" rel="noopener noreferrer" aria-label="Instagram profile">
